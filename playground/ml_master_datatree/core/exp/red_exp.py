...
class RedExp(NodeExp):
    ...
    def run(
        ...
        data_loader_usage_path = Path("playground/ml_master_datatree/prompts/tools/dataloader_en.md")
        ...
        search_tool_path = "playground/ml_master_datatree/prompts/tools/search.md"
