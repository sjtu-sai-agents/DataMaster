...
@register_playground("ml_master_datatree")
class DataTreePlayground(BasePlayground):
    ...
    def _create_test_metric_agent(self) -> None:
        ...
        self.test_metric_agent = Agent(
            ...
            tools=self.tools,
            system_prompt_file="${PROJECT_ROOT}/playground/ml_master_datatree/prompts/metric_test/system_prompt.md",
            user_prompt_file="${PROJECT_ROOT}/playground/ml_master_datatree/prompts/metric_test/user_prompt.md",
