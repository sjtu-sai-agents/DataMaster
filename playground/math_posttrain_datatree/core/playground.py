...
from .utils.uct import MetricReview, UCTSearchConfig, UCTSearchManager

logger = logging.getLogger(__name__)


@register_playground("math_posttrain_datatree")
class MathPostTrainDataTreePlayground(BasePlayground):
    def __init__(self, config_dir: Path | None = None, config_path: Path | None = None):
        if config_path is None and config_dir is None:
            config_dir = Path(__file__).parent.parent.parent.parent / "configs" / "math_posttrain_datatree"
    ...
    def run(self, task_description: str, output_file: str | None = None) -> dict:
        ...
        search_mgr = UCTSearchManager(self._search_config())
