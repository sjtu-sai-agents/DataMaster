"""Memory Tree MCP Interface - Provides tools for agents to interact with memory tree.

This MCP server exposes tools for agents to:
...
mcp = FastMCP("memory_tree_interface")
