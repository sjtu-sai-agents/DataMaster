...
logger = logging.getLogger("ml_master_warmup_vis")
...
def parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    p = argparse.ArgumentParser("ml_master_warmup_vis")
    p.add_argument("--run_dir", required=True, help="EvoMaster run dir, e.g. runs/ml_master_warmup_20260204_115212")
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    logger.info("ml_master_warmup_vis serving run_dir=%s", run_dir)
