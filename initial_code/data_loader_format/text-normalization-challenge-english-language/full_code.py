...
# --------------------------------------------------------------
# Global cache for normalization (will be updated from DataLoader)
# --------------------------------------------------------------
norm_cache = {}
...
# --------------------------------------------------------------
# Rule-based normalization helpers
# --------------------------------------------------------------
DIGIT_WORDS = {
    0: 'zero', 1: 'one', 2: 'two', 3: 'three', 4: 'four', 5: 'five',
    6: 'six', 7: 'seven', 8: 'eight', 9: 'nine', 10: 'ten',
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Text Normalization Training Script')
    parser.add_argument('--input_dir', type=str, default='./input',
                        help='Input directory containing training and test data')
...
def main():
    ...
    train_data, test_df = data_loader.get_data()
    
    # Update global norm_cache with data from DataLoader
    norm_cache.clear()
    norm_cache.update(train_data['norm_cache'])
    
    # Extract data structures
    bad_befores = train_data['bad_befores']
    mem_counts = train_data['mem_counts']
    left_counts = train_data['left_counts']
    right_counts = train_data['right_counts']
    tri_counts = train_data['tri_counts']
